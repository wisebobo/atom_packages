    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function getUserPreferences(scriptDoc) {
            ...
            return {
                ...
                includeAutomaticOptionalChainCompletions: (_a = baseConfig.suggest.includeAutomaticOptionalChainCompletions) !== null && _a !== void 0 ? _a : true,
        ...
        return {
            ...
            doValidation(doc, cancellationToken) {
                return __awaiter(this, void 0, void 0, function* () {
                    if (yield cancellationToken_1.isVCancellationRequested(cancellationToken)) {
                        return [];
                    }
            ...
            doComplete(doc, position) {
                ...
                const completions = service.getCompletionsAtPosition(fileFsPath, offset, Object.assign(Object.assign({}, getUserPreferences(scriptDoc)), { triggerCharacter: getTsTriggerCharacter(triggerChar), includeCompletionsWithInsertText: true, includeCompletionsForModuleExports: config.vetur.completion.autoImport }));
                if (!completions) {
                    return { isIncomplete: false, items: [] };
                }
                ...
                return {
                    ...
                    items: entries.map((entry, index) => {
                        ...
                        const item = {
                            ...
                            textEdit: range && vscode_languageserver_types_1.TextEdit.replace(range, entry.insertText || entry.name),
                        ...
                        if (entry.kindModifiers) {
                            const kindModifiers = parseKindModifier((_a = entry.kindModifiers) !== null && _a !== void 0 ? _a : '');
                            ...
                            if (kindModifiers.color) {
                                item.kind = vscode_languageserver_types_1.CompletionItemKind.Color;
                            }
                        }
                        return item;
                    })
            ...
            doResolve(doc, item) {
                ...
                const fileFsPath = paths_1.getFileFsPath(doc.uri);
                const details = service.getCompletionEntryDetails(fileFsPath, item.data.offset, item.label, getFormatCodeSettings(config), item.data.source, getUserPreferences(scriptDoc));
            ...
            getFoldingRanges(doc) {
                ...
                return spans.map(s => {
                    ...
                    const endLine = range.end.character > 0 &&
                        ['}', ']'].includes(scriptDoc.getText(vscode_languageserver_types_1.Range.create(vscode_languageserver_types_1.Position.create(range.end.line, range.end.character - 1), range.end)))
            ...
            getCodeActions(doc, range, _formatParams, context) {
                ...
                const result = [];
                const fixes = service.getCodeFixesAtPosition(fileName, start, end, fixableDiagnosticCodes, formatSettings, getUserPreferences(scriptDoc));
