...
class VLS {
    ...
    init(params) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const config = this.getFullConfig((_a = params.initializationOptions) === null || _a === void 0 ? void 0 : _a.config);
    ...
    getFullConfig(config) {
        return config ? _.merge(config_1.getDefaultVLSConfig(), config) : config_1.getDefaultVLSConfig();
    }
    setupConfigure(config) {
    ...
    setupConfigListeners() {
        this.lspConnection.onDidChangeConfiguration(({ settings }) => __awaiter(this, void 0, void 0, function* () {
            yield this.setupConfigure(this.getFullConfig(settings));
        }));
    ...
    setupCustomLSPHandlers() {
        ...
        this.lspConnection.onRequest('$/getDiagnostics', (params) => __awaiter(this, void 0, void 0, function* () {
            const doc = this.documentService.getDocument(params.uri);
            if (doc) {
                const diagnostics = yield this.doValidate(doc);
    ...
    triggerValidation(textDocument) {
        ...
        this.pendingValidationRequests[textDocument.uri] = setTimeout(() => {
            ...
            if ((tsDep === null || tsDep === void 0 ? void 0 : tsDep.state) === 0 /* Loaded */) {
                this.cancellationTokenValidationRequests[textDocument.uri] = new cancellationToken_1.VCancellationTokenSource(tsDep.module);
    ...
    validateTextDocument(textDocument, cancellationToken) {
        return __awaiter(this, void 0, void 0, function* () {
            const diagnostics = yield this.doValidate(textDocument, cancellationToken);
            if (diagnostics) {
                this.lspConnection.sendDiagnostics({ uri: textDocument.uri, diagnostics });
            }
        });
    }
    doValidate(doc, cancellationToken) {
        return __awaiter(this, void 0, void 0, function* () {
            const diagnostics = [];
                ...
                for (const lmr of this.languageModes.getAllLanguageModeRangesInDocument(doc)) {
                    if (lmr.mode.doValidation) {
                        if (this.validation[lmr.mode.getId()]) {
                            pushAll(diagnostics, yield lmr.mode.doValidation(doc, cancellationToken));
                        }
